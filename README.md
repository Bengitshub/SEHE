...
| About · FAQ · Gallery · Himalayan Trust (rebuild, Sep 2026) | `SEHE-about-page_v6.txt` · `SEHE-faq-page_v7.txt` · `SEHE-gallery-page_v7.txt` · `SEHE-himalayan-trust-page_v5.txt` | single widget each; copy ported verbatim from the live pages |
| Privacy Policy · Terms (rebuild, Sep 2026) | `SEHE-privacy-policy-page_v5.txt` · `SEHE-terms-page_v4.txt` | new layout; wording identical to live except the edits Kirsty approved on 26 Sep 2026 (the build proves it) |
